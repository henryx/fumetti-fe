package com.application.fumetti.frontend.views;


import com.application.fumetti.frontend.views.about.AboutView;
import com.application.fumetti.frontend.views.editors.EditorsView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Editori", "la la-book", EditorsView.class),
